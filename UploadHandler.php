...
class UploadHandler
{
    ...
    $this->options = array(
            ...
            'upload_dir' => $upload_array['basedir'].'/'.COMMENTSMULTIIMAGES_DIR_IMG.'/'.$current_user_id.'/',
            'upload_url' => $upload_array['baseurl'].'/'.COMMENTSMULTIIMAGES_DIR_IMG.'/'.$current_user_id.'/',
            ...
            'inline_file_types' => '/\.('.get_option('comment_mi_inline_file_types').')$/i',
            // Defines which files (based on their names) are accepted for upload:
            'accept_file_types' => '/\.('.get_option('comment_mi_accepted_file_types').')$/i',
            // The php.ini settings upload_max_filesize and post_max_size
            // take precedence over the following max_file_size setting:
            'max_file_size' => (1048576*get_option('comment_mi_maximum_file_size')),
            'min_file_size' => 1,
            ...
            //     */
            //     'thumbnail' => array(
            //         'max_width' => get_option('comment_mi_thumbnail_width'),
            //         'max_height' => get_option('comment_mi_thumbnail_height')
            //     )
            //)
        );
        if ($options) {
